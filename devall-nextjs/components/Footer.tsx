        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <svg width="40" height="40" viewBox="0 0 600 600" className="fill-red-600">
                <path d="M300 20l40 120 120-40-40 120 120 40-120 40 40 120-120-40-40 120-40-120-120 40 40-120-120-40 120-40-40-120 120 40z"/>
              </svg>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-red-500">Services</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-red-500">Company</h4>
            <ul className="space-y-2">
              {[
        ...
        <div className="border-t border-gray-700 pt-8 mt-8">
          ...
          <div className="text-center mt-6">
            <p className="text-gray-500 text-sm">
              Made with <Heart className="w-4 h-4 text-red-600 fill-red-600 inline-block" /> and <Leaf className="w-4 h-4 text-red-600 fill-red-600 inline-block" /> by DevAll Team
            </p>
          </div>
        </div>
      </div>
